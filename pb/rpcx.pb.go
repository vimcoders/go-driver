...
var file_rpcx_proto_rawDesc = []byte{
	...
	0x1a, 0x0b, 0x6c, 0x6f, 0x67, 0x69, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x27, 0x0a,
	...
	0x32, 0x6b, 0x0a, 0x0c, 0x4c, 0x6f, 0x67, 0x69, 0x63, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	...
	0x69, 0x6e, 0x67, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x2e, 0x0a,
...
var file_rpcx_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_rpcx_proto_goTypes = []any{
...
var file_rpcx_proto_depIdxs = []int32{
	0, // 0: pb.LogicService.Ping:input_type -> pb.PingRequest
	2, // 1: pb.LogicService.Login:input_type -> pb.LoginRequest
	1, // 2: pb.LogicService.Ping:output_type -> pb.PingResponse
	3, // 3: pb.LogicService.Login:output_type -> pb.LoginResponse
...
func file_rpcx_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_rpcx_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_rpcx_proto_msgTypes[1].Exporter = func(v any, i int) any {
