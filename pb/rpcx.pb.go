...
var file_rpcx_proto_rawDesc = []byte{
	...
	0x32, 0x66, 0x0a, 0x07, 0x48, 0x61, 0x6e, 0x64, 0x6c, 0x65, 0x72, 0x12, 0x2b, 0x0a, 0x04, 0x50,
...
var file_rpcx_proto_depIdxs = []int32{
	0, // 0: pb.Handler.Ping:input_type -> pb.PingRequest
	2, // 1: pb.Handler.Login:input_type -> pb.LoginRequest
	1, // 2: pb.Handler.Ping:output_type -> pb.PingResponse
	3, // 3: pb.Handler.Login:output_type -> pb.LoginResponse
